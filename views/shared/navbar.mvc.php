<nav class="navbar navbar-expand-md sticky-top py-3 navbar-dark" id="mainNav">
    <div class="container">
        ...
        <button data-bs-toggle="collapse" class="navbar-toggler justify-content-end" data-bs-target="#navcol-1">
                <span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse ms-auto justify-content-end" id="navcol-1">
            <a class="btn btn-primary shadow ms-auto" role="button" href="{{ URL_ROOT }}/register">Register</a>
        </div>
    </div>
</nav>